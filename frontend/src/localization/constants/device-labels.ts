...
export const DEVICE_LABELS = {
  ...
  FIELDS: {
    ...
    LAST_KNOWN_IP_ADDRESS: '最新IP Address',
  ...
  PLACEHOLDERS: {
    ...
    SSH_USERNAME: 'SSHログインIDを入力',
    SSH_PASSWORD: 'SSHパスワードを入力',
  ...
  HELP_TEXT: {
    ...
    SSH_USERNAME: 'サーバーが SSH 接続時に使うログインユーザー名です（オプション）',
    SSH_PASSWORD: 'サーバーが SSH 接続時に使うパスワードです。画面上は伏字表示されます（オプション）',
  ...
  TABLE: {
    ...
    SORT_BY: {
      ...
      LAST_KNOWN_IP_ADDRESS: '最新IP Addressでソート',
      SSH_USERNAME: 'SSHログインIDでソート',
      SSH_PASSWORD: 'SSHパスワードでソート',
  ...
  VALIDATION: {
    ...
    SSH_USERNAME_MAX_LENGTH: 'SSHログインIDは100文字以内で入力してください',
    SSH_PASSWORD_MAX_LENGTH: 'SSHパスワードは255文字以内で入力してください',
