...
export const SETTINGS_LABELS = {
  // 効率性設定関連
  EFFICIENCY: '稼働分類',
  EFFICIENCY_SETTINGS: '稼働分類設定',
  EFFICIENCY_ADDRESS: '稼働分類アドレス',
  EFFICIENCY_ADDRESSES: '稼働分類アドレス',
  NEW_EFFICIENCY_ADDRESS: '新しい稼働分類アドレスを作成',
  EDIT_EFFICIENCY_ADDRESS: '稼働分類アドレスを編集',
  CREATE_EFFICIENCY_ADDRESS: '稼働分類アドレスを作成',
  DELETE_EFFICIENCY_ADDRESS: '稼働分類アドレスを削除',
  EFFICIENCY_ADDRESS_CREATED: '稼働分類アドレスを作成しました',
  EFFICIENCY_ADDRESS_UPDATED: '稼働分類アドレスを更新しました',
  EFFICIENCY_ADDRESS_DELETED: '稼働分類アドレスを削除しました',
  EFFICIENCY_ADDRESS_CREATE_FAILED: '稼働分類アドレスの作成に失敗しました',
  EFFICIENCY_ADDRESS_UPDATE_FAILED: '稼働分類アドレスの更新に失敗しました',
  EFFICIENCY_ADDRESS_DELETE_FAILED: '稼働分類アドレスの削除に失敗しました',
  EFFICIENCY_ADDRESS_FETCH_FAILED: '稼働分類アドレスの取得に失敗しました',
  EFFICIENCY_ADDRESS_DELETE_CONFIRM: 'この稼働分類アドレスを削除してもよろしいですか？この操作は取り消せません。',
  MANAGE_EFFICIENCY_ADDRESSES: 'デバイスの稼働分類アドレスを管理します',
  
  // IO設定関連
  IO_SETTINGS: `${TECHNICAL_TERMS.IO}設定`,

  // 外部連携設定関連
  EXTERNAL_CONNECTORS: '外部連携設定',
  EXTERNAL_CONNECTORS_DESCRIPTION: 'デバイスデータを外部システムへ定期送信するコネクタを管理します',
  CONNECTOR_NAME: 'コネクタ名',
  CONNECTOR_TYPE: 'データ種別',
  CONNECTOR_URL: '送信先URL',
  CONNECTOR_API_KEY_HEADER: 'APIキーヘッダー名',
  CONNECTOR_API_KEY_VALUE: 'APIキー',
  CONNECTOR_SEND_INTERVAL: '送信間隔（分）',
  CONNECTOR_INITIAL_SYNC_DAYS: '手動送信取得日数',
  CONNECTOR_IS_ENABLED: '有効',
  CONNECTOR_LAST_SENT_AT: '最終送信日時',
  CONNECTOR_ADD: 'コネクタを追加',
  CONNECTOR_EDIT: 'コネクタを編集',
  CONNECTOR_DELETE: 'コネクタを削除',
  CONNECTOR_DELETE_CONFIRM: 'このコネクタを削除してもよろしいですか？この操作は取り消せません。',
  CONNECTOR_TRIGGER: '今すぐ送信',
  CONNECTOR_TRIGGER_QUEUED: '送信タスクをキューに投入しました',
  CONNECTOR_FETCH_FAILED: 'コネクタの取得に失敗しました',
  CONNECTOR_SAVE_FAILED: 'コネクタの保存に失敗しました',
  CONNECTOR_DELETE_FAILED: 'コネクタの削除に失敗しました',
  CONNECTOR_TRIGGER_FAILED: '送信の実行に失敗しました',
  CONNECTOR_NOT_SENT_YET: '未送信',
  CONNECTOR_TYPE_AGGREGATED_DATA: '生産実績',
  CONNECTOR_TYPE_ALARM_DATA: 'アラームデータ',
  CONNECTOR_TYPE_CYCLE_TIME_HISTORY: '基準CTデータ',
  CONNECTOR_TYPES: {
    aggregated_data: '生産実績',
    alarm_data: 'アラームデータ',
    efficiency_data: '稼働分類ログ',
    cycle_time_history: '基準CTデータ',
  } as Record<string, string>,
  CONNECTOR_ON_DUPLICATE: '重複時の動作',
  CONNECTOR_ON_DUPLICATE_APPEND: '常に追加（デフォルト）',
  CONNECTOR_ON_DUPLICATE_SKIP: '重複をスキップ',
  CONNECTOR_ON_DUPLICATE_UPSERT: '重複を上書き更新',
  ...
  SELECT_DATE_RANGE_PLACEHOLDER: '開始日 〜 終了日を選択してください',
  SELECT_DATE_RANGE_FROM: '開始日',
  SELECT_DATE_RANGE_TO: '終了日',
  ENCODING_FORMAT: 'エンコード形式',
  SELECT_ENCODING: 'エンコード形式を選択',
  INTERVAL: '集計単位',
  INTERVAL_30MIN: '30分単位',
  INTERVAL_60MIN: '1時間単位',
